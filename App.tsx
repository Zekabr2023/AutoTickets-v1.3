...
function App() {
  ...
  const renderView = () => {
    ...
    if (empresaLogada.is_admin) {
      return <AdminDashboard empresa={empresaLogada} onLogout={handleLogout} />;
    }

    // Cliente normal
    switch (currentView) {
      case AppView.Dashboard:
        return <Dashboard empresa={empresaLogada} onOpenNewTicket={handleOpenNewTicket} onLogout={handleLogout} onEmpresaUpdate={handleEmpresaUpdate} />;
